...
def make_slug(**overrides):
    values = dict(osystem='linux', arch='x86_64', compiler='gcc-13.4.0',
                  runtime_link='shared', runtime_variant='release',
...
@pytest.mark.parametrize('overrides', [
    ...
    {'runtime_link': 'static', 'link': 'shared',
     'runtime_variant': 'release', 'variant': 'debug'},
])
...
def test_the_short_fields_stay_in_their_own_pairs():
    slug = make_slug(runtime_link='static', link='shared',
                     runtime_variant='release', variant='debug')
